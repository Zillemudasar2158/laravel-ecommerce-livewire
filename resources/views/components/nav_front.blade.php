                ...
                @if (Route::has('login'))
                    @auth
                        ...
                        <x-nav-link :href="route('cart.list')" :active="request()->routeIs('cart.list')">
                            <div class="flex items-center gap-1 text-sm font-semibold text-white hover:text-blue-600 transition-all duration-200 relative">
                        ...
                        <!-- For userlogin name ur dropdown for profile view -->
